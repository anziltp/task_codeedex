...
import '../auth/screen/newpasswordset_page.dart';
...
class ApiServices {
  ...
  ///Otp Verification
  Future<void> verifyOtp(BuildContext context, String email,
  ...
  Future<bool> requestPasswordReset(String email) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print(
            'Failed to send password reset request. Status code: ${response
                .statusCode}');
        return false;
      }
    } catch (error) {
  ...
  Future<void> verifyPasswordOtp(BuildContext context, String otpCode,
      String email) async {
    final String baseUrl = 'https://prethewram.pythonanywhere.com/api/';
